...
def seirnmodel(t, y, gamma, sigma, eta, R_init):
    dy = np.zeros(6)
...
def main():
    ...
    b_0 = R_init*gamma
    e_0 = 0
    solution = ode45(lambda t, y : seirnmodel(t,y, gamma, sigma, eta, R_init), [0, 400], [s_0, e_0, x_0, r_0, b_0, n_0])
    pyplot.figure()
    ...
    pyplot.plot(solution.t, solution.y[5,:], label="N")
